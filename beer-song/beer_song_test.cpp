...
BOOST_AUTO_TEST_CASE(sings_second_verse)
{
	string expected = "2 bottles of beer on the wall, 2 bottles of beer.\n"
		"Take one down and pass it around, 1 bottle of beer on the wall.\n";

	BOOST_REQUIRE_EQUAL(expected, beer::verse(2));
}

BOOST_AUTO_TEST_CASE(sings_three_and_two)
{
	string expected = "3 bottles of beer on the wall, 3 bottles of beer.\n"
		"Take one down and pass it around, 2 bottles of beer on the wall.\n"
		"\n"
	...
	BOOST_REQUIRE_EQUAL(expected, beer::sing(3,2));
}
